...
long long dis[MAXN][MAXN],mat[MAXN][MAXN],flow[MAXN][MAXN];
int a[MAXN],b[MAXN];
int n,p,cow;
long long l,r,m;

//求网络最大流,邻接表形式
int max_flow(int n,long long mat[][MAXN],int source,int sink,long long flow[][MAXN]){
	long long pre[MAXN],que[MAXN],d[MAXN],p,q,t,i,j,r;
